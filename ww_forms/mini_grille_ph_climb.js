...
function get_score(period){
    ...
    var do_grille_calc = function(code){ // return this function which can use the pseudo-global variables
...
*/				
    ...
    } // end do_grille_calc function
    return (do_grille_calc); // return this function which can access pseudo_global variables
} // end grille_calcs closure function
...
function do_solve(){
	...
	*/
    do_grille_calc = grille_calcs(); // returns a function and initializes scoring table
    do_grille_calc(buffer);
