...
function initialize(){
   ...
   hclimber = new Worker('vigfamily_ph_climb2.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('vigfamily_ph_climb2.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('vigfamily_ph_climb2.js');
...
function do_check(){
	...
	s = document.getElementById('b_period').value;
	if (s == ''){
...
function do_solve(){
	...
	str = str+':'+n;
	period = document.getElementById('b_period').value;	
	str = str+':'+period;
	sel = document.myform.vtype.selectedIndex;
	type_selected=document.myform.vtype.options[sel].value;
	str += ':'+type_selected;
    if (document.getElementById('prog_key').checked)
        str += ':1';
    else if (document.getElementById('nicodemus').checked)
        str += ':2';
    else
        str += ':0';
    //alert(str);        
