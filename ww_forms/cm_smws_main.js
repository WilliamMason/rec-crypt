...
function initialize(){
   ...
   hclimber = new Worker('cm_smws_search.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('cm_smws_search.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('cm_smws_search.js');
...
function do_solve(){
	...
	str += ':'+s;	
	s = document.getElementById('left_key_len').value
	str += ':'+s;	
	s = document.getElementById('right_key_len').value
	str += ':'+s;	
