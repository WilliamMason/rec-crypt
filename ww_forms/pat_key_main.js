...
function do_search(){
    ...
    if (document.getElementById('custom_tet_table').checked) {
        if ( book_string == ''){
...
function initialize_workers(){
   ...
   hworker = new Worker('pat_key_worker.js');
   ...
   hworker2 = new Worker('pat_key_worker.js');
...
onload=function(){
    ...
    document.getElementById('clear').addEventListener("click",do_clear);   	
    ...
    document.getElementById('custom_tet_table').addEventListener("change", set_reload); 
