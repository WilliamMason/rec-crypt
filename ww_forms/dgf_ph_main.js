...
function initialize(){
   ...
   hclimber = new Worker('digrafid_ph_climb.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('digrafid_ph_climb.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('digrafid_ph_climb.js');
...
function do_check(){
	...
	s = document.getElementById('max_key_len').value;
	if (s == ''){
