...
function initialize(){
   ...
   hclimber = new Worker('periodic_gromark_ph_climb.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('periodic_gromark_ph_climb.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('periodic_gromark_ph_climb.js');
...
function do_check(){
    ...
    if (primerless_flag == 0) {
        s = document.getElementById('t_primer').value;
        if (s == ''){
    ...
    if (document.getElementById('custom_table').checked == true && book_string=='') {
...
function do_solve(){
	...
	str = str+':'+n;
    if (primerless_flag == 0)
        primer = document.getElementById('t_primer').value;	
    else 
        primer = '1';
        
	str = str+':'+primer;
    str += ':'+primerless_flag;
    str += ':'+document.getElementById('max_key_len').value;
	...
	if(numb_workers>1) {
        ...
        str += ':'+primerless_flag;
        str += ':'+document.getElementById('max_key_len').value;
        //str += ':'+document.getElementById('primer_limit').value;
...
function numb_trials_default(){
    if ( document.getElementById('known_p').checked) {
        //document.getElementById('numb_trials').value="3000000";
        primerless_flag = 0;
    }
    else {
