...
function initialize(){
   ...
   hclimber = new Worker('pollux_ph_climb.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('pollux_ph_climb.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('pollux_ph_climb.js');
...
function do_check(){
    ...
    if (s1.length==0){
        alert("Ciphertext does not contain any digits! Not Pollux!");
        return(false);
    }
	return(true);
}
