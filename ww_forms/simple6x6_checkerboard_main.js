...
function initialize(){
   ...
   hclimber = new Worker('simple6x6_checkerboard_climb.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('simple6x6_checkerboard_climb.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('simple6x6_checkerboard_climb.js');
