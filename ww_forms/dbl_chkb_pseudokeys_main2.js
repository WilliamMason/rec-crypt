...
function get_key_letters(){
   ...
   for (i=0;i<str.length;i++){
	...
	s = v_keys;
	s += '('+v_keys.length+')';
	document.getElementById('vert_key_letters').value = s;
	...
	s = h_keys;
	s += '('+h_keys.length+')';	
	document.getElementById('hor_key_letters').value = s;
...
onload = function() {
	...
	document.getElementById('get_key_letters').addEventListener("click",get_key_letters);     
	// unscramble
    document.getElementById('do_solve2').addEventListener("click",do_solve2);    
