...
function initialize(){
   ...
   hclimber = new Worker('twin_trifid_ph_climb.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('twin_trifid_ph_climb.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('twin_trifid_ph_climb.js');
...
function do_check(){
	...
	if (s == ''){
		alert("No period 1 entered");
		return(false);
	}
	if (parseInt(s) == 0){
		alert("Need period 1 greater than zero!");
		return(false)
	}
	s = document.getElementById('input_area2').value;
	if (s == ''){
		alert("No text 2 entered");
		return(false)
	}
	s = document.getElementById('t_period2').value;
	if (s == ''){
		alert("No period 2 entered");
		return(false);
	}
	if (parseInt(s) == 0){
		alert("Need period 2 greater than zero!");
		return(false)
	}
	s = document.getElementById('c_start').value;
	if (s == ''){
		alert("No common start 1 entered");
		return(false);
	}
	s = document.getElementById('c_start2').value;
	if (s == ''){
		alert("No common start 2 entered");
		return(false);
	}
	s = document.getElementById('c_len').value;
	if (s == ''){
		alert("No common length entered");
		return(false);
	}
	if (parseInt(s) == 0){
		alert("Need common length greater than zero!");
		return(false)
	}
...
function do_solve(){
	...
	str = str+':'+period;
	c_start = document.getElementById('c_start').value;	
	str = str+':'+c_start;
	period2 = document.getElementById('t_period2').value;	
	str = str+':'+period2;            
	c_start2 = document.getElementById('c_start2').value;	
	str = str+':'+c_start2;
