...
function initialize(){
   ...
   hclimber = new Worker('s2s4_ph_climb3.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('s2s4_ph_climb3.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('s2s4_ph_climb3.js');
...
function do_solve(){
	...
	str = '@'+max_trials;
	if(document.getElementById('s4t').checked || document.getElementById('s42').checked)
		str +=':0';
	else
		str += ':1';
	...
	if(numb_workers>1) {
		str = '@'+max_trials;
		if(document.getElementById('s4t').checked || document.getElementById('s24').checked )
			str +=':0';
		else
			str += ':1';
		//ff = parseFloat(document.settings.fudgefactor.value);	
