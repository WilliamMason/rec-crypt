...
function initialize(){
   ...
   hclimber = new Worker('pseudohat_ph_climb.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('pseudohat_ph_climb.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('pseudohat_ph_climb.js');
...
function do_check(){
    ...
    if ( document.getElementById('sum').checked || document.getElementById('aussie').checked){
        for (i=0;i<=max_index;i++) {
            if (used_index[i] == 0){
                s1 = "Pattern incomplete. It has no "+alpha.charAt(i)+" !";
                alert(s1);
                return(false);
            }
            if (used_index[i] >1 ){
                s1 = "Pattern incorrect. It has more than one "+alpha.charAt(i)+" !";
                alert(s1);
                return(false);
            }
        }
...
function do_solve(){
    ...
    if(document.getElementById('sum').checked)
        hc_type = '0';
    else if(document.getElementById('aussie').checked)
        hc_type = '1';
    else // myszkowski
        hc_type = '2';    
