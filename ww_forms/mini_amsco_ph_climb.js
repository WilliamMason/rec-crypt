...
function get_trial_decrypt(period){
    ...
    var do_amsco_calc = function(code){ // return this function which can use the pseudo-global variables
...
*/		
    ...
    } // end do_amsco_calc function
    return (do_amsco_calc); // return this function which can access pseudo_global variables
} // end amsco_calcs closure function
...
function do_solve(){
	...
	*/
    do_amsco_calc = amsco_calcs(); // returns a function and initializes scoring table
    do_amsco_calc(buffer);
