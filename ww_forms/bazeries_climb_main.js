...
function initialize(){
   ...
   hclimber = new Worker('bazeries_climb_worker.js');
   ...
   if (numb_workers>1){
   		hclimber2 = new Worker('bazeries_climb_worker.js');
   ...
   if (numb_workers>2){
   		hclimber3 = new Worker('bazeries_climb_worker.js');
...
function do_check(){
	...
	if (s1.indexOf('j') != -1 && !document.getElementById('use_6x6').checked){
