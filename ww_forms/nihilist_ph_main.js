...
function initialize(){
   ...
   if ( document.getElementById('size6').checked)
    cname = 'nihilist6x6_ph_climb.js';
   else
    cname='nihilist_ph_climb.js';
    
   hclimber = new Worker(cname);
...
function do_clear(){
    ...
    document.getElementById('b_period').value = '';	
}
...
onload = function() {
    ...
    document.getElementById('size6').addEventListener("change",function(){stop_flag=1;});
